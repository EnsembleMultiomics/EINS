...
## -----------------------------------------------------------------------------
head(EINS_NCI60$Ensemble$Samples$CHC$ClusterRes$Clusters_5)
plot(EINS_NCI60$Ensemble$Samples$CHC$HClustTree$Clusters_5)

## -----------------------------------------------------------------------------
EINS_NCI60$run_Ensemble_Sample_MDS_HC(Clusters = 5)

## -----------------------------------------------------------------------------
head(EINS_NCI60$Ensemble$Samples$MDS_HC$ClusterRes$Clusters_5)
head(EINS_NCI60$Ensemble$Samples$MDS_HC$MDS$Clusters_5$points)
head(EINS_NCI60$Ensemble$Samples$MDS_HC$DimensionInfo$Clusters_5$StabilityMatrix)
plot(EINS_NCI60$Ensemble$Samples$MDS_HC$HClustTree$Clusters_5)
...
## -----------------------------------------------------------------------------
EINS_NCI60$Plots$Scatterplot$MoCluster$Factors_5

## -----------------------------------------------------------------------------
EINS_NCI60$plot_Clusters_Metadata(MetadataFeatures = c("tissue of origin", "Epithelial", "sex", "p53"))

## -----------------------------------------------------------------------------
EINS_NCI60$Plots$Clusters_Metadata$Ensemble$MDS_HC$Clusters_5
...
## -----------------------------------------------------------------------------
EINS_NCI60$plot_Dendrogram(Data = "Ensemble CHC", MetadataHeight = -4, Clusters = 5, MetadataFeatures = c("tissue of origin", "Epithelial", "p53"), LabelMetadata = "tissue of origin", LabelSize = 0.5, BarLabelSize = 0.5)

## -----------------------------------------------------------------------------
EINS_NCI60$plot_Dendrogram(Data = "Ensemble MDS_HC", MetadataHeight = -1.5, Clusters = 5, MetadataFeatures = c("tissue of origin", "Epithelial", "p53"), LabelMetadata = "tissue of origin", LabelSize = 0.5, BarLabelSize = 0.5)
