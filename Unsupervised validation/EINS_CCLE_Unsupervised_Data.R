...
CCLE_groups=rownames(temp[temp[,4]%in%primary_site_temp[1:3],])

CCLE_Meta <- CCLE_313_Meta[(rownames(CCLE_313_Meta) %in% CCLE_groups), ]
CCLE_Prot <- CCLE_313_Prot[,(colnames(CCLE_313_Prot) %in% CCLE_groups) ]
CCLE_Metab <- CCLE_313_Metab[,(colnames(CCLE_313_Metab) %in% CCLE_groups) ]
CCLE_miRNA <- CCLE_313_miRNA[,(colnames(CCLE_313_miRNA) %in% CCLE_groups) ]
CCLE_Meth <- CCLE_313_Meth[,(colnames(CCLE_313_Meth) %in% CCLE_groups) ]
CCLE_RNA <- CCLE_313_RNA[,(colnames(CCLE_313_RNA) %in% CCLE_groups) ]
...
EINS_CCLE$add_Omics_df(OmicsName = "Proteomics", DataDF = CCLE_Prot, MetaDF = CCLE_Meta)
EINS_CCLE$add_Omics_df(OmicsName = "Metabolomics", DataDF = CCLE_Metab, MetaDF = CCLE_Meta)
EINS_CCLE$add_Omics_df(OmicsName = "miRNA", DataDF = CCLE_miRNA, MetaDF = CCLE_Meta)
EINS_CCLE$add_Omics_df(OmicsName = "Methylation", DataDF = CCLE_Meth, MetaDF = CCLE_Meta)
EINS_CCLE$add_Omics_df(OmicsName = "Transcriptomics", DataDF = CCLE_RNA, MetaDF = CCLE_Meta)
...
#Change components for 3-9 groups
EINS_CCLE$run_MoCluster(Clusters = 2:20, Components = 3, Linkage = "ward.D2")

#Run MCIA multi-omics integration
#Change components for 3-9 groups
EINS_CCLE$run_MCIA(PerformCluster = T, Clusters = 2:20, Components = 3)

#Run MOFA multi-omics integration
#Change factors for 3-9 groups
EINS_CCLE$run_MOFA(PerformCluster = T, Clusters = 2:20, Factors = 3)
...
#Change DatasetClusters for 3-9 groups
EINS_CCLE$run_COCA(DatasetClusters = 3, FullClusters = 2:20, FullClusterMethod  = "hclust", FullHClustMethod = "ward.D2")
...
#Change ConcatUMAPDimensions for 3-9 groups
EINS_CCLE$run_GAUDI(ClusterMethod = "Kmeans", KmeansClusters = 2:20, SingleOmicsUMAPDimensions = 15, ConcatUMAPDimensions = 3)
...
saveRDS(EINS_CCLE, file = "CCLE_Unsuper_Eval_3.rds")
